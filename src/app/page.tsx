...
import CenterOnboardingForm from '@/components/CenterOnboardingForm';
...
export default function Home() {
  ...
  return (
    <div className="w-full relative z-0 bg-white">
      ...
      {/* Split-Screen Center Form */}
      {showFormModal && <CenterOnboardingForm onClose={() => setShowFormModal(false)} />}
    </div>
  );
}
